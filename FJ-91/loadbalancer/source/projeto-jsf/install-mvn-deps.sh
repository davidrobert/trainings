...
mvn install:install-file -DgroupId=de.javakaffee.web.msm -DartifactId=msm-kryo-serializer -Dversion=1.4.1 -Dpackaging=jar -Dfile=lib/msm-kryo-serializer-1.4.1.jar
